...
def main(page: Page):
    ...
    functionText = TextField(
        value="", color=ft.colors.PURPLE, text_size=20, on_submit=submit1
    )
    ...
    startscaleText = TextField(
        value="", color=ft.colors.PURPLE, text_size=20, on_submit=submit2
    )
